...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --disable-linux-perf --prefix=/media/lyhao/DATA1/code/GitHub/ijkplayer/android/contrib/build/ffmpeg-arm64/output --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/media/lyhao/DATA1/code/GitHub/ijkplayer/android/contrib/build/openssl-arm64/output/include ' --extra-ldflags=' -L/media/lyhao/DATA1/code/GitHub/ijkplayer/android/contrib/build/openssl-arm64/output/lib -lssl -lcrypto '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/media/lyhao/DATA1/code/GitHub/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/media/lyhao/DATA1/code/GitHub/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
